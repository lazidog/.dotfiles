...
# Google Chrome
alias edge='f(){ open -a "Microsoft Edge" https://www.google.com/search\?q\="$@";  unset -f f; }; f'
alias chrome='f(){ open -a "Google Chrome" https://www.google.com/search\?q\="$@";  unset -f f; }; f'
...
# pnpm
export PNPM_HOME="/Users/lazidog/Library/pnpm"
case ":$PATH:" in
  *":$PNPM_HOME:"*) ;;
...
export PATH="/Users/lazidog/.antigravity/antigravity/bin:$PATH"
